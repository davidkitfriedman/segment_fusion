...
#define IS_ODD(a) ((long)(a) & 1)
#define MAKE_ODD(a)  ((arc_forward *) ((long)(a) | 1))
#define MAKE_EVEN(a) ((arc_forward *) ((long)(a) & (~1)))
#define MAKE_ODD_REV(a)  ((arc_reverse *) ((long)(a) | 1))
#define MAKE_EVEN_REV(a) ((arc_reverse *) ((long)(a) & (~1)))
...
#define NEIGHBOR_NODE_REV(i, shift) ((node *) ((char *)(i) - (shift)))
	...
	{
		long				shift;		/* node_to = NEIGHBOR_NODE(node_from, shift) */
