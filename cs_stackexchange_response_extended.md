...
I wonder about whether if early research in computer networking has been funded more by companies and less by government the current situation today would be more monetized and more balkanized; competing protocol, glue technology, and additional fees for packets going from one network to another. Bills for Internet service would vary month to month depending on the destination of the packets. 
